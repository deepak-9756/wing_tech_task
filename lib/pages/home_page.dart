...
import 'package:flutter_slidable/flutter_slidable.dart' show ActionPane, DrawerMotion, IconSlideAction, Slidable, SlidableAction, SlidableDrawerActionPane;
import 'package:wing_tech_task/auth.dart';
import 'package:wing_tech_task/models/employee.dart';
import 'package:wing_tech_task/pages/ProfilePage.dart';
    ...
    body: StreamBuilder<List<Employees>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Slidable(
                    ...
                    // Right side swipe actions (replace secondaryActions)
                    endActionPane: ActionPane(
                      motion: const DrawerMotion(), // or const ScrollMotion()
                      extentRatio: 0.25,
                      children: [
                        SlidableAction(
                          onPressed: (_) => delete(user.uid),
                    ...
                    child: GestureDetector(
                      ...
                      onLongPress: () => _modifier(user: user),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
          ...
          // Default list when no search filter
          return Container(
            color: Colors.grey.shade900,
